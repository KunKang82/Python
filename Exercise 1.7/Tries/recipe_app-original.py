...
#     # for i in range(len(all_ingredients_list)):
#     #   index = i + 1
#     #   tup = all_ingredients_list[i]
#     #   print(str(index) + ". " + tup[1])
      
#     try:
#       # User to pick a number from all_ingredients_list. THis number is used as the index to retrieve the corresponding ingredient,
#       # which is then stored into a variable called ingredient
...
#       # Print the filter conditions, not the objects
#       # print("Conditions: ", [str(condition) for condition in conditions])
